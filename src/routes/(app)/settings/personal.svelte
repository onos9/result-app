            ...
            <div class="grid grid-cols-6 gap-6">
              <div class="relative col-span-6 sm:col-span-3">
                <input
                  ...
                  placeholder=" "
                />
                <label for="firstName" class="floating-label peer-focus:text-accent-focus">First Name</label>
              </div>
              ...
              <div class="relative col-span-6 sm:col-span-3">
                <input
                  ...
                  placeholder=" "
                />
                <label for="lastName" class="floating-label peer-focus:text-accent-focus"> Last Name </label>
              </div>
              ...
              <div class="relative col-span-6 sm:col-span-3">
                <input
                  ...
                  placeholder=" "
                />
                <label for="phone" class="floating-label peer-focus:text-accent-focus"> Phone Number </label>
              </div>
                ...
                <div class="mt-4 space-y-4">
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      class="radio"
                    />
                    <label for="female" class="ml-3 block text-sm font-medium leading-6 ">Female</label>
                  </div>
                </div>
              </fieldset>
              ...
              <div class="relative col-span-6">
                <input
                  ...
                  placeholder=" "
                />
                <label for="address" class="floating-label peer-focus:text-accent-focus"> Street address </label>
              </div>
              ...
              <div class="relative col-span-6 sm:col-span-6 lg:col-span-2">
                <input
                  ...
                  placeholder=" "
                />
                <label for="state" class="floating-label peer-focus:text-accent-focus">State / Province</label>
              </div>
              ...
              <div class="relative col-span-6 sm:col-span-6 lg:col-span-2">
                <input
                  ...
                  placeholder=" "
                />
                <label for="zip" class="floating-label peer-focus:text-accent-focus"> ZIP / Postal code </label>
              </div>
            </div>
